...
public class FutureJodaTest {
	...
	@Test
	public void shouldPassWithFutureDate() {
		final Set<ConstraintViolation<Object>> violations = this.validator.validate(
				new Object() {
					@FutureJoda
	...
	@Test
	public void shouldPassWithFutureDateWhenNowIsValid() {
		final Set<ConstraintViolation<Object>> violations = this.validator.validate(
				new Object() {
					@FutureJoda(nowValid=true)
					private LocalDate date = LocalDate.now().plusDays(1);
	...
	@Test
	public void shouldFailWithHistoricDate() {
		final Set<ConstraintViolation<Object>> violations = this.validator.validate(
				new Object() {
					@FutureJoda
	...
	@Test
	public void shouldFailWithHistoricDateWhenNowIsValid() {
		final Set<ConstraintViolation<Object>> violations = this.validator.validate(
				new Object() {
					@FutureJoda(nowValid=true)
					private LocalDate date = LocalDate.now().minusDays(1);
